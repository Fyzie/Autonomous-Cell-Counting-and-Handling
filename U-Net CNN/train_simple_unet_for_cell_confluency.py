...
# model.load_weights('cell_confluence_test.hdf5')
...
model.save('cell_confluence_test.hdf5')
#
############################################################
#Evaluate the model
...
model = get_model()
model.load_weights('cell_confluence_test.hdf5') #Trained for 50 epochs and then additional 100
